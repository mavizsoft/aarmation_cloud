...
const DashboardPage: React.FC<{liveData: iotDataObject[]; pumpLive: number}> = ({
  liveData,
  pumpLive,
}) => (
  <>
...
/>
    ...
    <div className='row g-5 g-xl-8 mb-5 mb-xl-8'>
      <div
        className={`alert d-flex align-items-center p-5 mb-10 ${
          pumpLive ? 'alert-info' : 'alert-warning'
        } `}
      >
        <span
          className={`svg-icon svg-icon-2hx svg-icon-info  me-3  svg-icon-${
            pumpLive ? 'info' : 'warning'
          }`}
        >
          <span
            className={`svg-icon svg-icon-2hx svg-icon-info  me-4  svg-icon-${
              pumpLive ? 'info' : 'warning'
            }`}
          >
            <svg
              ...
              className='mh-50px text-success'
            >
              <path
                opacity='0.3'
        ...
        <div className='d-flex flex-column'>
          <h5 className={`mb-1 fs-5 text-bold text-uppercase text-${pumpLive ? 'info' : 'warning'}`}>
            {pumpLive ? `Pump ${pumpLive} is running` : 'No pump running'}
          </h5>
        </div>
      </div>
      {/* begin::Col */}
      <div className='col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10'>
        <CardsWidget7
          className='h-md-50 mb-5 mb-xl-10 bg-light-info'
          description='ENERGY - KVAH'
          title='KVAH'
          icon={true}
        ...
        />
        <CardsWidget7
          className='h-md-50 mb-5 mb-xl-10  bg-light-primary'
          description='VOLTAGE - L-L'
          title='VOLTAGE - L-L'
          icon={false}
      ...
      <div className='col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10'>
      <CardsWidget7
          className='h-md-50 mb-5 mb-xl-10 bg-light-danger'
        ...
        />
      <CardsWidget7
          className='h-md-50 mb-5 mb-xl-10  bg-light-secondary'
          description='VOLTAGE - L-N'
          title='VOLTAGE_LN'
          icon={false}
      ...
      <div className='col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10'>
      <CardsWidget7
          className='h-md-50 mb-5 mb-xl-10 bg-light-success'
          description='LOAD - KVA'
          title='KVA'
          icon={true}
        ...
        />
        <CardsWidget7
          className='h-md-50 mb-5 mb-xl-10  bg-light'
      ...
      <div className='col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10'>
      <CardsWidget7
          className='h-md-50 mb-5 mb-xl-10  bg-light-warning'
...
const DashboardWrapper: FC = () => {
  ...
  const getData = async () => {
    ...
    const pumpNumber =
      pumpData && pumpData.tag === 'PLC:PUMP_1_FB'
        ? 1
        : pumpData && pumpData.tag === 'PLC:PUMP_2_FB'
        ? 2
        : 0
  ...
  return (
    <>
      ...
      <h2 className='blink_me text-danger ' >  LIVE DATA </h2>
      <DashboardPage liveData={liveData} pumpLive={pumpLive} />
    </>
  )
}
